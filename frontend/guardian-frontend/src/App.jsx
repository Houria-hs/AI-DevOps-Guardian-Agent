...
import { Shield, Zap, Code, Terminal, AlertTriangle, CheckCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">{iconMap[type]}</div>
